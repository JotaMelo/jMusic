...
open class KeychainSwift {
    ...
    open func set(_ value: String, forKey key: String,
                  withAccess access: KeychainSwiftAccessOptions? = nil, touchID: Bool = false) -> Bool {
        
        if let value = value.data(using: String.Encoding.utf8) {
            return set(value, forKey: key, withAccess: access, touchID: touchID)
        }
    ...
    open func set(_ value: Data, forKey key: String,
        ...
        if #available(iOS 9, *), touchID {
            let accessControl = SecAccessControlCreateWithFlags(kCFAllocatorDefault, kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly, .touchIDAny, nil)
            
            query.removeValue(forKey: KeychainSwiftConstants.accessible)
     ...
     */
    open func get(_ key: String, touchIDPromptMessage: String? = nil) -> String? {
        if let data = getData(key, touchIDPromptMessage: touchIDPromptMessage) {
     ...
     */
    open func getData(_ key: String, touchIDPromptMessage: String? = nil) -> Data? {
        let prefixedKey = keyWithPrefix(key)
        ...
        if let touchIDPromptMessage = touchIDPromptMessage {
            query[kSecUseOperationPrompt as String] = touchIDPromptMessage
        }
